...
export default function Form(props) {
    ...
    return (
        ...
        >
            ...
            <div className={`p-length ${password.passwordLength < 12 ? 'text-red-600' : password.passwordLength < 20 ? 'text-yellow-600' : 'text-green-600'}`}>
            ...
            <div className="p-strength my-8 border-gray-500 border-l-8 md:grid grid-flow-col border-none items-center md:my-10 md:dark:ring-1 "> 
                ...
                {/*strength =>  high */}
                <label className={`m-4 cursor-pointe ${password.strength == 'high' ? 'text-green-600 text-3xl lg:text-4xl font-extrabold' : ''}`}>
                    <input className="mr-3"
                        type="radio"
                        name="strength"
                        value='high'
             ...
             <div className="pass-icon s:text-green-400 s:rounded-md s:bg-white md:py-2 relative"> 
                {/* display password */}
